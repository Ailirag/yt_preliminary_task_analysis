...
#    YATRACKER_TOKEN_GT, YATRACKER_ORGID_GT  — трекер/вики (уже есть)
...
- LLM не имеет пишущих инструментов (только read-only поиск по коду и вики) — инъекция из текста
  задачи не может ничего записать.
